...
const GAMES = [
    {
        image: '/game-covers/game-forza.jpg',
    ...
    {
        image: '/game-covers/game-batlle.jpg',
    ...
    {
        image: '/game-covers/game-life.jpg',
    ...
    {
        image: '/game-covers/game-gta.jpg',
    ...
    {
        image: '/game-covers/game-rainbow_siege.jpg',
    ...
    {
        image: '/game-covers/game-ass.jpg',
...
const Home = () => {
    return (
        <div className='home-page'>
           {GAMES.map(game => <GameItem id={game.id} game={game} /> 
           )}
        </div>
    );
};
